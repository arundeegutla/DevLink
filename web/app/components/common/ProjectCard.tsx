...
export default function ProjectCard(item: condensedGroup) {
  ...
  return (
    <Link
      ...
      className={`transition-all duration-300 ease-in-out relative rounded-lg mr-4 mt-4 bg-[#22222253] p-2 border-l-[5px] cursor-pointer overflow-hidden w-80 h-44 border-2 border-gray-600 ${
        hovering && ``
      }`}
      style={{
